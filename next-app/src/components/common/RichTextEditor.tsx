...
const RichTextEditor: React.FC<RichTextEditorProps> = ({
    ...
    return (
        <>
            ...
            <div className={`flex flex-col border rounded-md overflow-hidden transition-all duration-300 bg-white ${isExpanded ? 'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[95%] max-w-4xl h-[60vh] z-[9999] shadow-2xl border-blue-200' : 'relative h-auto'} ${className}`}>
                {/* Toolbar */}
                <div className="flex items-center justify-between px-2 py-1 bg-gray-50 border-b border-gray-100 select-none">
                    <div className="flex items-center gap-1">
                        <button
                            ...
                            className="p-1 rounded hover:bg-gray-200 text-gray-600 flex items-center justify-center transition-colors"
                            title="Negrito"
                            disabled={disabled}
                        >
                    ...
                    <button
                        ...
                        className="p-1 rounded hover:bg-blue-100 text-blue-600 flex items-center justify-center transition-colors"
                ...
                {isExpanded && (
                    <div className="bg-gray-50 border-t px-4 py-2 flex justify-between items-center shrink-0">
                        ...
                        <button 
                            ...
                            className="px-4 py-1.5 bg-blue-600 text-white rounded font-bold text-xs uppercase shadow-sm hover:bg-blue-700 transition-colors"
                        >
                            Concluir e Voltar
                        </button>
                    </div>
