  ...
  return (
    <>
      ...
      >
        ...
        >
          <div>
            <h3 className="text-sm font-black text-gray-900 uppercase tracking-tight">Selecionar Produto</h3>
        ...
        <div className="px-5 pt-4 pb-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-xs font-bold uppercase placeholder:text-gray-300 tracking-wide bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-300 transition-all"
            />
            {searching && (
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-1">
          ...
          {searchResults.map(product => (
            <button
              ...
              className="w-full flex items-center gap-3 p-2.5 rounded-xl hover:bg-blue-50 transition-all group text-left border border-transparent hover:border-blue-100"
            >
              {/* Thumbnail */}
              <div
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[11px] font-bold text-gray-800 uppercase leading-tight truncate group-hover:text-blue-700 transition-colors">
                  {product.name}
                </p>
                <div className="flex items-center gap-2 mt-0.5">
                  {product.code && (
                    <span className="text-[9px] font-bold text-gray-400 uppercase">REF: {product.code}</span>
                  )}
                  {product.source && (
                    <span
