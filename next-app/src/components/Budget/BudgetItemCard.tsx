...
const BudgetItemCard: React.FC<BudgetItemCardProps> = ({
    ...
    const handlePaymentChange = (val: number, label: string) => {
        ...
        updateItem(it.id, 'mockPaymentDesc', label);
                                        ...
                                        <div className="flex-[2] space-y-2">
                                            ...
                                            <div className="flex gap-2 items-center flex-wrap">
                                                ...
                                                <div className="relative">
                                                    <input 
                                                        type="number"
                                                        className={`w-[92px] rounded-[var(--radius-md-budget)] border px-2 py-1.5 text-[11px] font-mono-budget font-[700] text-center focus:ring-0 transition-all ${it.isManualMargin ? 'bg-[var(--color-accent-budget)] text-white border-[var(--color-accent-budget)] shadow-sm' : 'bg-white border-[#D0D3D6] text-[var(--text-secondary-budget)]'}`}
