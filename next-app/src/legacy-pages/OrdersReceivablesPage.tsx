        ...
        <div className="max-w-[1920px] w-full mx-auto p-4 md:p-6 space-y-5">
            ...
            <div className="grid grid-cols-3 gap-3">
                {[
                    ...
                    <div key={i} className="bg-white rounded-lg border border-gray-200 p-3 border-l-4" style={{ borderLeftColor: c.color === 'blue' ? '#3b82f6' : c.color === 'indigo' ? '#6366f1' : '#7c3aed' }}>
                        <div className="flex items-center gap-1.5 mb-1">
                            <span className="material-icons-outlined text-gray-400 text-sm">{c.icon}</span>
                            <span className="text-[10px] font-bold text-gray-400 uppercase">{c.label}</span>
                        </div>
                        <p className="text-base font-black text-gray-800">{formatCurrency(c.value)}</p>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
                <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
                    ...
                    <IssuerSelect className="form-select text-sm rounded-lg border-gray-300" value={filterIssuer} onChange={setFilterIssuer} includeAll allLabel="Todos Emissores" />
                        ...
                        <div key={o.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-sm transition-shadow">
                            <div className="px-2 py-1.5 text-sm flex items-center gap-3 cursor-pointer" onClick={() => setExpandedId(expanded ? null : o.id)}>
                                ...
                                <div className="flex-1 min-w-0 grid grid-cols-2 md:grid-cols-6 gap-2 items-center">
                                    ...
                                    <div className="text-right"><p className="text-sm font-bold text-gray-900">{formatCurrency(getSaleValueLocal(o))}</p><p className="text-xs text-gray-400">Venda</p></div>
            ...
            {confirmModal.isOpen && confirmModal.order && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm border border-gray-100 overflow-hidden text-center transform scale-100 transition-all">
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl p-4 mx-6 my-4 text-left">
                        ...
                        <div className="bg-white p-4 flex gap-3 border-t overflow-hidden">
                            <button onClick={() => setConfirmModal({ ...confirmModal, isOpen: false })} className="flex-1 px-4 py-2.5 bg-white border border-gray-200 text-gray-600 rounded-xl font-bold hover:bg-gray-50 transition-colors">Sair</button>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm border border-gray-100 overflow-hidden transform scale-100 transition-all">
                        ...
                        <div className="bg-white p-4 border-t flex gap-3">
                            <button onClick={() => setPlanModal({ isOpen: false, order: null })} className="flex-1 px-4 py-2.5 bg-white border border-gray-200 text-gray-600 rounded-xl font-bold hover:bg-gray-50">Cancelar</button>
