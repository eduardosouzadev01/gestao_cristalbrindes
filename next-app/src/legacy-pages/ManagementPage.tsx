                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
                        <div className="p-6 border-b border-gray-100 bg-white">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
                                <div>
                                    <h2 className="text-lg font-black text-gray-900 uppercase tracking-tight">Planilha de Atendimentos</h2>
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                <div className="relative flex-1 min-w-[280px]">
                                    ...
                                    <input 
                                        ...
                                        className="w-full pl-14 pr-4 py-2.5 bg-gray-50/50 border border-gray-100 rounded-xl text-[11px] font-black text-gray-600 uppercase tracking-tight outline-none focus:ring-4 focus:ring-blue-500/10 focus:bg-white focus:border-blue-200 transition-all"
                                        value={searchTerm}
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select 
                                            className="pl-9 pr-8 py-2.5 bg-white border border-gray-100 rounded-xl text-[11px] font-black text-gray-600 uppercase tracking-tight outline-none focus:ring-4 focus:ring-blue-500/10 hover:bg-gray-50 transition-all appearance-none"
                                    ...
                                    {kanbanPeriodFilter === 'Custom' && (
                                        <div className="flex items-center gap-2 bg-blue-50/50 p-1.5 rounded-xl border border-blue-100 animate-in fade-in zoom-in-95 duration-200">
                                            <input
                                                type="date"
                                                className="border-0 bg-transparent text-[10px] font-black text-blue-700 uppercase focus:ring-0 p-0 w-[100px]"
                                                value={startDate}
