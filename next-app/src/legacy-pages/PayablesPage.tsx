  ...
  return (
    <div className="max-w-[1920px] w-full mx-auto px-4 py-4 space-y-4">
      ...
      <div className="grid grid-cols-12 gap-3 items-end">
        <div className="col-span-12 lg:col-span-4 bg-white p-1 rounded border border-gray-200 flex gap-1">
          {[
        ...
        <div className="col-span-12 lg:col-span-8 bg-white p-1.5 rounded border border-gray-200 shadow-sm flex items-center flex-wrap gap-2">
          ...
          <IssuerSelect className="h-8 px-2 border border-gray-300 rounded text-[10px] font-black uppercase bg-white" value={issuerFilter} onChange={setIssuerFilter} includeAll allLabel="TODAS EMPRESAS" />
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {filteredCosts.map((c, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-1.5">
                      <span className="px-1.5 py-0.5 rounded bg-white text-[8px] font-black text-gray-600 uppercase border border-gray-200 shadow-sm">{c.label}</span>
                    </td>
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {filteredExpenses.map(e => (
                <tr key={e.id} className={`hover:bg-blue-50/30 group ${e.paid ? 'opacity-60 bg-white' : e.due_date < todayStr ? 'bg-red-50' : ''}`}>
                  ...
                  <td className="px-4 py-2"><span className="px-1.5 py-0.5 rounded bg-white border text-[8px] font-black uppercase tracking-tighter">{e.category}</span></td>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-[2px]">
          {expenseModal ? (
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <IssuerSelect className="w-full px-2 border border-gray-300 rounded h-8 text-[9px] font-black uppercase" value={expenseForm.issuer} onChange={v => setExpenseForm({ ...expenseForm, issuer: v })} />
                  </div>
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm border border-gray-100 overflow-hidden text-center transform scale-100 transition-all">
              ...
              {confirmModal.item && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 mx-6 mb-6 text-left relative overflow-hidden">
              ...
              <div className="bg-white p-4 flex gap-3 border-t">
                <button onClick={() => setConfirmModal({ ...confirmModal, isOpen: false })} className="flex-1 px-4 py-2.5 bg-white border border-gray-200 text-gray-600 rounded-xl font-bold hover:bg-gray-50">Sair</button>
