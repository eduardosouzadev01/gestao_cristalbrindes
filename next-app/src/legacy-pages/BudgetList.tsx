                    ...
                    <div className="flex-1 min-w-[300px]">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="block w-full pl-14 pr-3 py-1.5 rounded-lg border-gray-200 bg-gray-50 focus:bg-white border shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 text-xs font-bold transition-all placeholder:text-gray-400 placeholder:font-normal"
                                value={searchTerm}
                                    ...
                                    <td className="px-3 py-1.5 whitespace-nowrap">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="flex items-center gap-2 mt-0.5">
                                                <span className="text-[9px] text-slate-400 font-bold uppercase leading-none">{ISSUERS.find(i => i.id === (b.issuer || 'CRISTAL'))?.fullName}</span>
