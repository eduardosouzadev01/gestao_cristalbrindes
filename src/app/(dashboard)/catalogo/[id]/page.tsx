    ...
    return (
      <div className="flex items-center justify-center h-[calc(100vh-52px)]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest animate-pulse">Carregando editor...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-[calc(100vh-52px)] overflow-hidden" style={{ fontFamily: displayCatalog.font_family }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden" style={{ background: '#e8ecf0' }}>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            {Object.keys(pendingChanges).length > 0 && (
              <span className="text-[9px] font-medium text-amber-500 uppercase tracking-widest animate-pulse">● Alterações pendentes</span>
            )}
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => router.push(`/catalogo/${id}/preview`)}
              className="flex items-center gap-1.5 h-8 px-4 border border-gray-200 rounded-md text-[10px] font-medium uppercase tracking-widest text-gray-600 hover:bg-gray-50 transition-all active:scale-95"
            >
            ...
            <button
              ...
              disabled={saving}
              className="flex items-center gap-1.5 h-8 px-5 rounded-md text-[10px] font-medium uppercase tracking-widest text-white transition-all hover:opacity-90 disabled:opacity-60 shadow-none active:scale-95"
        ...
        {/* Canvas area */}
        <div className="flex-1 overflow-auto flex items-start justify-center p-12 bg-gray-100/50">
          {pagesLoading ? (
            ...
            >
              <div style={{ width: 794, height: 1123 }} className="relative flex items-center justify-center bg-gray-900">
                {displayCatalog.cover_image ? (
                  ...
                  <div className="flex flex-col items-center gap-3 text-white opacity-50 z-10 p-12 text-center">
                    <span className="material-icons-outlined text-gray-400" style={{ fontSize: 56 }}>photo_camera</span>
                    <p className="text-sm tracking-widest font-medium uppercase">Nenhuma imagem de capa</p>
                    <p className="text-xs text-gray-400 leading-relaxed">Vá na guia "Capa" ao lado para enviar a imagem de capa do seu catálogo.</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div 
              style={{ transform: 'scale(0.78)', transformOrigin: 'top center' }}
              className="relative shadow-none overflow-hidden rounded-md"
            >
              <div 
                style={{ 
                  width: 794, 
                ...
                <div className="flex flex-col items-center w-full max-w-2xl space-y-16">
                  ...
                  <div className="flex flex-col items-center space-y-6 pt-12 border-t w-full" style={{ borderColor: 'rgba(0,0,0,0.1)' }}>
                    {displayCatalog.back_cover_website && (
                      <div className="flex items-center gap-4 text-2xl font-medium" style={{ color: displayCatalog.secondary_color }}>
            ...
            <div style={{ transform: 'scale(0.78)', transformOrigin: 'top center' }} className="shadow-none rounded-md">
              <PageCanvas
                page={currentPage}
                catalog={displayCatalog as any}
            ...
            <div className="flex flex-col items-center justify-center gap-4 opacity-50 p-24 text-center">
              <div className="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center">
                <span className="material-icons-outlined text-gray-400 text-4xl">style</span>
              </div>
              <div className="space-y-1">
                <p className="text-[11px] font-medium text-gray-800 uppercase tracking-widest leading-none">Página não selecionada</p>
                <p className="text-[10px] text-gray-400 uppercase tracking-widest font-medium">Selecione ou adicione uma página na lateral</p>
              </div>
            </div>
          )}
        </div>
