...
const LoginPage: React.FC = () => {
    ...
    useEffect(() => {
        if (isAuthenticated) {
            const dest = localStorage.getItem('lastPath') || '/';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (result.success) {
            // The useEffect will handle the redirection if authenticated is true
        } else {
        ...
        <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#F5F5F5' }}>
            <div className="relative z-10 w-full max-w-[440px] px-4">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-medium" style={{ color: '#242424', letterSpacing: '-0.01em' }}>Cristal Brindes</h1>
                    <p className="text-sm mt-1" style={{ color: '#616161' }}>Sistema de Gestão de Pedidos</p>
                </div>

                {/* Login Card */}
                <div className="bg-white rounded-md p-8" style={{ border: '1px solid #E0E0E0' }}>
                    <div className="mb-6">
                        <h2 className="text-lg font-medium" style={{ color: '#242424' }}>Entrar no Sistema</h2>
