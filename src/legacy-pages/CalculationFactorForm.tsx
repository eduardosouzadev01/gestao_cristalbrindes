    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="md:flex md:items-center md:justify-between mb-8">
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-2xl font-medium text-gray-900 sm:text-3xl flex items-center gap-3">
      ...
      <div className="space-y-6">
        <div className="bg-white shadow-none rounded-md overflow-hidden border border-gray-100">
          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <input type="text" value={name} onChange={e => setName(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Ex: Imposto Padrão Vendas" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700">Descrição</label>
              <textarea rows={3} value={description} onChange={e => setDescription(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Breve explicação sobre quando aplicar este fator."></textarea>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow-none rounded-md overflow-hidden border border-gray-100">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-md p-6 flex flex-col items-center justify-center border border-gray-200">
              <h4 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-4">Fator Resultante</h4>
              <div className="text-5xl font-medium text-blue-500 mb-2">{result}</div>
        ...
        <div className="flex justify-end gap-3 pb-8">
          ...
          <button onClick={saveFactor} disabled={loading} className="px-6 py-2 border border-transparent rounded-md shadow-none text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 disabled:opacity-50">
