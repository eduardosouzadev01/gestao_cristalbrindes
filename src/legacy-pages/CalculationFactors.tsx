  ...
  return (
    <div className="max-w-[1920px] w-full mx-auto px-4 sm:px-6 lg:px-8">
      <div className="md:flex md:items-center md:justify-between mb-8">
        ...
        <Link to="/configuracoes/fatores/novo" className="ml-3 inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-none text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 transition-colors">
          <span className="material-symbols-outlined mr-2">add</span> Adicionar Fator
        </Link>
      </div>

      <div className="bg-white shadow-none rounded-md overflow-hidden border border-gray-100">
        <div className="border-b border-gray-200 px-2 py-2 text-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="bg-blue-100 text-blue-500 py-1 px-3 rounded-md text-xs font-medium uppercase">Total</span>
            <span className="text-gray-900 font-medium">{factors.length} Fatores</span>
          </div>
          <div className="relative max-w-xs w-full">
            ...
            <input type="text" placeholder="Filtrar fatores..." className="block w-full !pl-10 pr-3 py-2 border border-gray-300 rounded-md text-sm" />
          </div>
        </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-2 py-2 text-sm text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/4">Nome do Fator</th>
              <th className="px-2 py-2 text-sm text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/2">Descrição</th>
              <th className="px-2 py-2 text-sm text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Multiplicador</th>
              ...
              <tr key={i} className="hover:bg-gray-50 transition-colors">
                <td className="px-2 py-2 text-sm">
                  <div className="flex items-center">
                    <div className={`h-10 w-10 rounded-md flex items-center justify-center bg-indigo-50 text-indigo-600`}><span className="material-symbols-outlined">percent</span></div>
                    <div className="ml-4">
                ...
                <td className="px-2 py-2 text-sm"><span className="inline-flex px-3 py-1 rounded-full text-sm font-medium bg-blue-50 text-blue-700">{calculateMultiplier(f)}</span></td>
