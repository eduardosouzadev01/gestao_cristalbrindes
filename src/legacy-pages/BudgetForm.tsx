        ...
        <div className="max-w-[1920px] w-full mx-auto px-4 py-4 space-y-4">
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center">
                    <button onClick={() => navigate('/orcamentos')} className="mr-3 p-1.5 rounded-full bg-white shadow-none border border-gray-200 text-gray-500 hover:bg-gray-50">
                ...
                <div className="flex gap-2 items-center">
                    {status === 'PROPOSTA ACEITA' ? (
                        <div className="flex gap-2">
                            <button onClick={duplicateBudget} disabled={loading} className="px-3 py-1.5 rounded-md shadow-none text-[10px] font-medium text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 transition-all uppercase flex items-center gap-1">
                                <span className="material-icons-outlined text-sm">content_copy</span> Duplicar
                            </button>
                            <button disabled className="px-3 py-1.5 rounded-md shadow-none text-[10px] font-medium text-gray-500 bg-gray-100 border border-gray-200 cursor-not-allowed uppercase flex items-center gap-1">
                                <span className="material-icons-outlined text-sm">lock</span> Pedido Gerado
                            </button>
                        </div>
                    ) : (
                        <>
                            <button onClick={duplicateBudget} disabled={loading} className="h-9 px-4 rounded-md shadow-none text-[10px] font-medium text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 transition-all uppercase flex items-center justify-center gap-2 active:scale-95 leading-none">
                                <span className="material-icons-outlined text-base">content_copy</span>
                                Duplicar
                            </button>
                            <button onClick={() => saveBudget(false)} disabled={loading} className="h-9 px-6 rounded-md shadow-none text-[10px] font-medium text-white bg-green-600 hover:bg-green-700 transition-all uppercase flex items-center justify-center gap-2 active:scale-95 leading-none">
                                <span className="material-icons-outlined text-base">save</span>
                                {loading && !isAutoSaving ? 'Salvando...' : 'Salvar'}
                            </button>
                            <div className="flex bg-white rounded-md border border-gray-200 shadow-none overflow-hidden hover:border-blue-300 transition-all group">
                                <button 
                                ...
                                <button 
                                    ...
                                    className="h-9 px-4 text-[10px] font-medium text-gray-700 hover:bg-gray-50/50 transition-all uppercase flex items-center justify-center gap-2 active:scale-95 leading-none bg-white group/pdf"
                                >
                            ...
                            <button onClick={handleGenerateOrderClick} className="h-9 px-4 rounded-md shadow-none text-[10px] font-medium text-white bg-blue-500 hover:bg-blue-600 transition-all uppercase flex items-center justify-center gap-2 active:scale-95 leading-none">
            ...
            <div className="grid grid-cols-12 gap-4">
                {/* Informações Gerais */}
                <section className="col-span-12 xl:col-span-5 bg-white shadow-none rounded-md border border-gray-200 p-3">
                    <div className="flex items-center gap-2 mb-2 border-b border-gray-100 pb-1">
                        ...
                        <h3 className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">Geral</h3>
                    </div>
                    <div className="grid grid-cols-12 gap-2">
                        <div className="col-span-3">
                            <label className="block text-[9px] font-medium text-blue-600 uppercase mb-0.5">Nº Orçamento</label>
                            <input
                                className={`form-input block w-full text-center rounded-md border-gray-300 font-medium py-1 text-xs ${budgetNumber === 'AUTO' ? 'bg-blue-50 text-blue-600 border-blue-200' : ''}`}
                                placeholder="AUTO"
                                value={budgetNumber || ''}
                        ...
                        <div className="col-span-3">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">Vendedor</label>
                            <select
                                className={`form-select block w-full py-1 rounded-md text-xs font-medium border-gray-300 ${isSeller ? 'bg-gray-50 text-gray-500' : ''}`}
                                value={vendedor}
                        ...
                        <div className="col-span-3">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">Status</label>
                            <select className="form-select block w-full py-1 rounded-md text-xs border-gray-300 font-medium" value={status || ''} onChange={e => setStatus(e.target.value)} disabled={status === 'PROPOSTA ACEITA'}>
                        ...
                        <div className="col-span-3">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">Data</label>
                            <input type="date" className="form-input block w-full py-1 rounded-md text-xs border-gray-300" value={dataOrcamento || ''} onChange={e => setDataOrcamento(e.target.value)} disabled={status === 'PROPOSTA ACEITA'} />
                        </div>
                        <div className="col-span-12 mt-1">
                            <div className="flex items-center gap-2 bg-gray-50 p-1.5 rounded-md border border-gray-100">
                                <span className="text-[9px] font-medium text-gray-400 uppercase mr-2">Emitente:</span>
                                <div className="flex gap-1.5 flex-1">
                                    {['CRISTAL', 'ESPIRITO', 'NATUREZA'].map(op => (
                                        <button
                                            key={op}
                                            onClick={() => setIssuer(op)}
                                            className={`flex-1 py-1 px-2 border rounded-md font-medium text-[9px] transition-all uppercase ${issuer === op ? 'border-blue-500 bg-blue-500 text-white shadow-none' : 'border-gray-200 bg-white text-gray-400 hover:border-gray-300'} ${status === 'PROPOSTA ACEITA' ? 'opacity-50' : ''}`}
                ...
                {/* Dados do Cliente */}
                <section className="col-span-12 xl:col-span-7 bg-white shadow-none rounded-md border border-gray-200 p-3">
                    <div className="flex items-center gap-2 mb-2 border-b border-gray-100 pb-1">
                        <span className="material-icons-outlined text-blue-500 text-sm">person</span>
                        <h3 className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">Cliente</h3>
                    </div>
                    <div className="grid grid-cols-12 gap-2">
                        ...
                        <div className="col-span-3">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">CNPJ / CPF</label>
                            <input className="form-input w-full rounded-md border-gray-200 text-xs bg-gray-50 py-1 font-mono" value={clientData.doc || ''} readOnly />
                        </div>
                        <div className="col-span-4">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">Celular / WhatsApp</label>
                            <input className="form-input w-full rounded-md border-gray-200 text-xs bg-gray-50 py-1" value={clientData.phone || ''} readOnly />
                        </div>
                        <div className="col-span-6">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">E-mail Comercial</label>
                            <input className="form-input w-full rounded-md border-gray-200 text-xs bg-gray-50 py-1" value={clientData.email || ''} readOnly />
                        </div>
                        <div className="col-span-6">
                            <label className="block text-[9px] font-medium text-gray-400 uppercase mb-0.5">E-mail Financeiro</label>
                            <input className="form-input w-full rounded-md border-gray-200 text-xs py-1" value={clientData.emailFin || ''} onChange={e => setClientData({ ...clientData, emailFin: e.target.value })} disabled={status === 'PROPOSTA ACEITA'} />
                        </div>
                    </div>
                </section>
            </div>
            ...
            <section className="space-y-2">
                <div className="flex items-center justify-between px-1">
                    <h3 className="text-[10px] font-medium text-gray-400 uppercase tracking-widest flex items-center gap-2">
                        <span className="material-icons-outlined text-sm">inventory_2</span> Itens do Orçamento
                    </h3>
                    <div className="text-[10px] font-medium text-gray-400">
                        Total Geral: <span className="text-blue-600 text-sm font-medium">{formatCurrency(items.reduce((sum, it) => sum + calculateItemTotal(it), 0))}</span>
                    </div>
                </div>
                ...
                {status !== 'PROPOSTA ACEITA' ? (
                    <button onClick={addItem} className="w-full py-2.5 border-2 border-dashed border-blue-200 rounded-md text-blue-500 font-medium text-xs uppercase hover:bg-blue-50 transition-all flex items-center justify-center gap-2">
                        <span className="material-icons-outlined text-base">add_circle</span> Adicionar Novo Item
                    </button>
                ) : (
                    <div className="w-full py-2.5 border-2 border-dashed border-gray-100 rounded-md text-gray-400 font-medium text-[10px] uppercase flex items-center justify-center gap-2 bg-gray-50 italic">
            ...
            <section className="bg-white shadow-none rounded-md border border-gray-200 p-4 space-y-4">
                <div className="flex items-center gap-2 mb-2 border-b border-gray-100 pb-2">
                    <span className="material-icons-outlined text-blue-500 text-sm">assignment</span>
                    <h3 className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">Condições da Proposta</h3>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="border rounded-md p-3 bg-gray-50/50 focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-400 transition-all">
                        <label className="block text-[9px] font-medium uppercase text-gray-400 mb-1">Validade da proposta</label>
                        <input
                    ...
                    <div className="border rounded-md p-3 bg-gray-50/50 focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-400 transition-all">
                        <label className="block text-[9px] font-medium uppercase text-gray-400 mb-1">Frete</label>
                        <input
                            className="w-full bg-transparent border-none p-0 text-sm font-medium focus:ring-0"
                            value={shipping}
                    ...
                    <div className="border rounded-md p-3 bg-gray-50/50 focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-400 transition-all">
                        <label className="block text-[9px] font-medium uppercase text-gray-400 mb-1">Prazo de entrega</label>
                        <input
                            className="w-full bg-transparent border-none p-0 text-sm font-medium focus:ring-0"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border rounded-md p-3 bg-gray-50/50 focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-400 transition-all">
                        <label className="block text-[9px] font-medium uppercase text-gray-400 mb-1">Forma de Pagamento</label>
                        <select
                            className="w-full bg-transparent border-none p-0 text-sm font-medium focus:ring-0"
                            value={paymentMethod}
                    ...
                    <div className="border rounded-md p-3 bg-gray-50/50 focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-400 transition-all">
                        <label className="block text-[9px] font-medium uppercase text-gray-400 mb-1">Observações</label>
                        <input
                            className="w-full bg-transparent border-none p-0 text-sm font-medium focus:ring-0"
                            value={observation}
