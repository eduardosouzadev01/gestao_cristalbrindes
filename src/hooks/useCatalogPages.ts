...
import type { CatalogPage, CatalogSlot, CatalogPageWithSlots, CreatePageInput } from '../types/catalog';
...
export function useCatalogPages(catalogId: string | undefined) {
  ...
  return { pages, loading, error, fetchPages, addPage, deletePage, reorderPages, updatePageBg };
}
