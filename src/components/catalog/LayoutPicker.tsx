...
const LayoutPicker: React.FC<LayoutPickerProps> = ({ currentLayout, onSelect }) => {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(v => !v)}
        className="flex items-center gap-2 px-3 py-1.5 border border-gray-200 rounded-lg text-[10px] font-black uppercase tracking-widest text-gray-600 hover:bg-gray-50 transition-all"
      ...
      {open && (
        <>
          ...
          {/* Dropdown */}
          <div
            className="absolute top-full left-0 mt-1 z-50 bg-white border border-gray-100 rounded-2xl shadow-2xl p-3"
            style={{ width: 280 }}
          >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-center">
                      <div className="text-[10px] font-black uppercase tracking-widest">{layout.label}</div>
