  ...
  return (
    ...
    >
      ...
      <div className="relative group px-2 mb-2 pt-2">
        ...
        >
          <div
            className="w-full aspect-[3/4] rounded-md overflow-hidden relative transition-all"
            style={{
          ...
          >
            {catalogCoverImage ? (
              ...
              <span className="absolute inset-0 flex items-center justify-center text-[10px] text-gray-500 font-medium uppercase tracking-widest text-center px-1">Sem Capa</span>
            )}
          </div>
          <div className="flex items-center justify-center mt-1">
            <span className="text-[9px] font-medium uppercase tracking-widest" style={{ color: currentPageId === 'cover' ? '#1e3a5f' : '#9ca3af' }}>Capa</span>
          </div>
        </button>
      </div>
      ...
      <div className="px-2 mb-2">
        <button
          onClick={onAdd}
          disabled={isAdding}
          className="w-full flex flex-col items-center gap-1 py-2 rounded-md border-2 border-dashed transition-all disabled:opacity-50 hover:bg-gray-100"
      ...
      {catalogBackCover && (
        <div className="relative group px-2 mb-2 pt-2 border-t border-gray-200">
          ...
          >
            <div
              className="w-full aspect-[3/4] rounded-md overflow-hidden relative transition-all bg-white"
              style={{
            ...
            <div className="flex items-center justify-center mt-1">
              <span className="text-[9px] font-medium uppercase tracking-widest text-center" style={{ color: currentPageId === 'back_cover' ? '#1e3a5f' : '#9ca3af' }}>CONTRACAPA</span>
            </div>
          </button>
        </div>
      )}
