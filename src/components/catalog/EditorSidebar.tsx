    ...
    >
      ...
      <div className="grid grid-cols-4 border-b border-gray-200">
        {tabs.map(tab => (
          <button
            ...
            className="flex flex-col items-center justify-center gap-0.5 py-2.5 px-0.5 transition-all border-b-2 text-[9px] font-medium uppercase tracking-widest min-w-0"
            style={{
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        ...
        {activeTab === 'geral' && (
          <>
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Título do Catálogo</label>
              <input
                type="text"
                value={catalog.title}
                onChange={e => onChange({ title: e.target.value })}
                className="w-full px-3 py-2 border border-gray-200 rounded-md text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all"
              />
            </div>
          </>
        )}
        ...
        {activeTab === 'capa' && (
          <div>
            <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-2">Imagem de Capa</label>
            <input ref={logoInputRef} type="file" accept="image/*" className="hidden" onChange={handleLogoChange} />
            <button
              onClick={() => logoInputRef.current?.click()}
              disabled={logoUploading}
              className="w-full flex items-center justify-center gap-2 py-3 border border-dashed border-gray-300 rounded-md text-[10px] font-medium text-gray-500 hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-50"
            >
            ...
            {catalog.cover_image && (
              <button
                ...
                className="w-full mt-2 py-1.5 text-[10px] font-medium text-red-400 hover:text-red-600 transition-colors uppercase tracking-widest"
              >
                Remover imagem
              </button>
            )}
        ...
        {activeTab === 'contracapa' && (
          <div className="space-y-4">
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-2">Logo da Contracapa</label>
              <input ref={logoInputRef} type="file" accept="image/*" className="hidden" onChange={handleLogoChange} />
              <button
                onClick={() => logoInputRef.current?.click()}
                disabled={logoUploading}
            ...
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Cor da Contracapa</label>
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={catalog.back_cover_color || '#ffffff'}
                  onChange={e => onChange({ back_cover_color: e.target.value })}
                  className="flex-1 px-3 py-2 border border-gray-200 rounded-md text-xs font-mono font-medium uppercase focus:outline-none focus:ring-2 focus:ring-blue-200"
                />
              </div>
            </div>
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Mensagem Final</label>
              <textarea
                value={catalog.back_cover_message || ''}
                onChange={e => onChange({ back_cover_message: e.target.value || null })}
                className="w-full px-3 py-2 border border-gray-200 rounded-md text-xs text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all"
                placeholder="Muito obrigado pela preferência!"
                rows={2}
              />
            </div>
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Website (URL)</label>
              <input
                type="text"
                value={catalog.back_cover_website || ''}
                onChange={e => onChange({ back_cover_website: e.target.value || null })}
                className="w-full px-3 py-2 border border-gray-200 rounded-md text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-200"
                placeholder="www.seusite.com.br"
              />
            </div>
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Instagram (@)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Telefone / WhatsApp</label>
              <input
                type="text"
        ...
        {activeTab === 'fontes' && (
          <div>
            <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-2">Família Tipográfica</label>
        ...
        {activeTab === 'cores' && (
          <>
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Cor Primária (títulos)</label>
              <div className="flex items-center gap-2">
                <input
                  type="color"
            ...
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Cor Secundária (descrições)</label>
              <div className="flex items-center gap-2">
                <input
                  type="color"
            ...
            >
              <p className="text-xs font-medium" style={{ fontFamily: catalog.font_family, color: catalog.primary_color }}>
                Produto de Exemplo
              </p>
        ...
        {activeTab === 'fundo' && (
          <>
            <div>
              <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-2">Tipo de Fundo</label>
              <div className="grid grid-cols-3 gap-2">
                {(['solid', 'gradient', 'image'] as BgType[]).map(t => (
                  <button
                    key={t}
                    onClick={() => onChange({ bg_type: t })}
                    className="flex flex-col items-center gap-1.5 py-2.5 rounded-md border text-[9px] font-medium uppercase tracking-widest transition-all"
                    style={{
            ...
            {catalog.bg_type === 'solid' && (
              <div>
                <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">Cor do Fundo</label>
                <div className="flex items-center gap-2">
                  <input
                    type="color"
            ...
            {catalog.bg_type === 'gradient' && (
              <div>
                <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-2">Linear Gradient</label>
                
                <div className="space-y-3">
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex-1">
                      <label className="block text-[8px] font-medium text-gray-400 uppercase mb-1">Cor 1</label>
                      <input
                        type="color"
                        ...
                        className="w-full h-8 rounded-md border border-gray-200 cursor-pointer"
                      />
                    </div>
                    <div className="flex-1">
                      <label className="block text-[8px] font-medium text-gray-400 uppercase mb-1">Cor 2</label>
                      <input
                        type="color"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <label className="block text-[8px] font-medium text-gray-400 uppercase">Ângulo</label>
                ...
                <div
                  className="mt-3 h-12 rounded-md border border-gray-100 shadow-none-inner"
                  style={{ background: catalog.bg_value }}
                />
                
                <div className="mt-3 space-y-1">
                  <p className="text-[9px] text-gray-400 uppercase font-medium tracking-widest mb-1.5">Sugestões:</p>
                  <div className="grid grid-cols-2 gap-1.5">
                    {[
                      ...
                      <button
                        ...
                        className="w-full h-8 rounded-md border border-gray-200 transition-all hover:scale-105"
                        style={{ background: g }}
                      />
                    ))}
                  </div>
            ...
            {catalog.bg_type === 'image' && (
              <div>
                <label className="block text-[9px] font-medium text-gray-400 uppercase tracking-widest mb-1.5">URL da Imagem de Fundo</label>
                <input
                  type="text"
                  value={catalog.bg_value}
                  onChange={e => onChange({ bg_value: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-200 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-blue-200"
                  placeholder="https://..."
                />
              </div>
            )}
        ...
        {activeTab === 'logo' && (
          <>
            {catalog.logo_url && (
              <div className="flex justify-center p-4 bg-gray-50 rounded-md border border-gray-100">
            ...
            <button
              onClick={() => logoInputRef.current?.click()}
              disabled={logoUploading}
              className="w-full flex items-center justify-center gap-2 py-3 border border-dashed border-gray-300 rounded-md text-[10px] font-medium uppercase tracking-widest text-gray-500 hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-50"
            >
              <span className="material-icons-outlined text-sm">{logoUploading ? 'sync' : 'upload'}</span>
            ...
            {catalog.logo_url && (
              <button
                ...
                className="w-full py-2 text-[10px] font-medium uppercase tracking-widest text-red-400 hover:text-red-600 transition-colors"
              >
                Remover Logo
              </button>
            )}
