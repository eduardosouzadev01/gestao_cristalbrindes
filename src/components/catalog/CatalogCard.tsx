...
const CatalogCard: React.FC<CatalogCardProps> = ({ catalog, onDuplicate, onDelete }) => {
  ...
  return (
    <div
      className="group relative bg-white rounded-md overflow-hidden border transition-all duration-200 hover:shadow-none hover:-translate-y-0.5"
      ...
      >
        ...
        <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            ...
            className="w-7 h-7 rounded-md bg-white/90 flex items-center justify-center shadow-none hover:bg-white transition-all"
          ...
          <button
            ...
            className="w-7 h-7 rounded-md bg-white/90 flex items-center justify-center shadow-none hover:bg-red-50 transition-all"
        ...
        <div className="absolute bottom-2 left-3">
          <span
            className="text-white text-base font-medium leading-tight line-clamp-1 max-w-[180px]"
      ...
      <div className="px-4 py-3 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-md" style={{ background: catalog.primary_color }} />
            <div className="w-3 h-3 rounded-md" style={{ background: catalog.secondary_color }} />
            <span className="text-[9px] font-medium text-gray-400 uppercase tracking-widest">{catalog.font_family}</span>
          </div>
