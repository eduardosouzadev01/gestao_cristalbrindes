            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-6 space-y-4">
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <div className="col-span-12">
                            <label className="block text-[10px] font-black text-gray-400 uppercase mb-1">E-mail Comercial</label>
                            <input 
                                className="w-full px-3 py-2 border rounded-md text-sm font-medium focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all"
                        ...
                        <div className="col-span-12">
                            <label className="block text-[10px] font-black text-gray-400 uppercase mb-1">E-mail Financeiro</label>
                            <input 
                                className="w-full px-3 py-2 border rounded-md text-sm font-medium focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all"
                        ...
                        <div className="col-span-12">
                            <label className="block text-[10px] font-black text-gray-400 uppercase mb-1">Celular / WhatsApp</label>
                            <input 
                    ...
                    <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 flex gap-3 mt-4">
                ...
                <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                    <button 
                        onClick={onClose}
                        className="px-4 py-2 text-xs font-bold text-gray-500 hover:text-gray-700 transition-colors uppercase"
                    >
                        Cancelar
                    </button>
                    <button 
                        ...
                        disabled={loading}
                        className="px-6 py-2 bg-blue-600 text-white rounded-md text-xs font-black hover:bg-blue-700 disabled:opacity-50 shadow-md shadow-blue-100 transition-all flex items-center gap-2 uppercase tracking-wide"
                    >
