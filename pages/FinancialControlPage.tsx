    ...
    return (
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Planilha de Controle</h1>
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm w-64 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                            value={searchTerm}
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg font-bold text-sm hover:bg-gray-50 transition-colors"
                    >
                ...
                <div className="overflow-x-auto overflow-y-auto max-h-[calc(100vh-250px)]">
                    <table className="w-full text-left border-collapse min-w-[2800px]">
                        <thead className="sticky top-0 z-20 bg-gray-50 border-b border-gray-200">
                            <tr>
                                {/* Order Info */}
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider sticky left-0 bg-gray-50 border-r border-gray-200">Pedido</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider sticky left-[100px] bg-gray-50 border-r border-gray-200">Cliente</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Vendedor</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Data</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Entrega</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Emitente</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider border-r border-gray-200">NF</th>

                                {/* Item Info */}
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Produto</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Qtd</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Venda Unit.</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Total Venda</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider border-r border-gray-200">Saldo Cliente</th>

                                {/* Costs Info */}
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center bg-red-50/50">Custo Prod (R$)</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center bg-red-50/50">Custo Pers (R$)</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center bg-red-50/50">Frete Forn (R$)</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center bg-red-50/50">Frete Cli (R$)</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center bg-red-50/50">Extra (R$)</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center bg-red-50/50 border-r border-gray-200">Layout (R$)</th>

                                {/* Payment Dates & Paid Status */}
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center">Pg Fornec</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center">Data Forn</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center">Pg Pers</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center">Data Pers</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center">Pg Frete</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center border-r border-gray-200">Data Frete</th>

                                {/* Financial Result */}
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider bg-green-50/50">Lucro Bruto</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider bg-green-50/50">Margem (%)</th>
                                <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-right">Status do Pedido</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                            {filteredData.map((item, idx) => (
                                <tr key={`${item.order_id}-${item.id}-${idx}`} className="hover:bg-gray-50/80 transition-colors text-[12px] group">
                                    {/* Order Info */}
                                    <td className="px-4 py-2.5 font-bold text-blue-600 sticky left-0 bg-white border-r border-gray-100 group-hover:bg-gray-50">#{item.order_number}</td>
                                    ...
                                    <td className="px-4 py-2.5 font-bold text-gray-900">{formatCurrency(item.total_item_value || (item.quantity * item.unit_price))}</td>
                                    ...
                                    <td className="px-4 py-2.5 text-center">
                                        <button 
                                            ...
                                            className={`p-1 rounded transition-colors ${item.unit_price_paid ? 'text-green-600 hover:bg-green-50' : 'text-gray-300 hover:bg-gray-100'}`}
                                        >
                                    ...
                                    <td className="px-4 py-2.5 text-center">
                                        <button 
                                            ...
                                            className={`p-1 rounded transition-colors ${item.customization_paid ? 'text-green-600 hover:bg-green-50' : 'text-gray-300 hover:bg-gray-100'}`}
                                        >
                                    ...
                                    <td className="px-4 py-2.5 text-center">
                                        <button 
                                            ...
                                            className={`p-1 rounded transition-colors ${item.supplier_transport_paid ? 'text-green-600 hover:bg-green-50' : 'text-gray-300 hover:bg-gray-100'}`}
                                        >
                                    ...
                                    {/* Result */}
                                    <td className={`px-4 py-2.5 font-bold bg-green-50/5 ${item.gross_profit >= 0 ? 'text-green-700' : 'text-red-700'}`}>
                                        {formatCurrency(item.gross_profit)}
                                    </td>
                                    <td className={`px-4 py-2.5 font-bold bg-green-50/5 ${item.margin_percent >= 25 ? 'text-green-700' : item.margin_percent >= 15 ? 'text-yellow-700' : 'text-red-700'}`}>
