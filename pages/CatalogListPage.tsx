    ...
    <div className="max-w-[1920px] w-full mx-auto px-6 py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={creating}
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-widest text-white transition-all hover:opacity-90 active:scale-95 disabled:opacity-60 shadow-sm"
          style={{ background: '#1e3a5f' }}
        >
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-24 gap-3">
          ...
          <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">Carregando catálogos...</p>
        </div>
      ) : catalogs.length === 0 ? (
        /* Empty state */
        <div
          className="flex flex-col items-center justify-center py-24 gap-5 rounded-2xl border-2 border-dashed"
        ...
        >
          ...
          <div className="text-center">
            <h2 className="text-sm font-black text-gray-400 uppercase tracking-wide">Nenhum catálogo criado</h2>
          ...
          <button
            onClick={handleCreate}
            disabled={creating}
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest text-white transition-all hover:opacity-90 shadow-md disabled:opacity-60"
            style={{ background: '#1e3a5f' }}
          >
