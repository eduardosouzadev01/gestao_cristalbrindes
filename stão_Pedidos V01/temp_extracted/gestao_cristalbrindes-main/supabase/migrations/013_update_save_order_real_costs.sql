-- 013_update_save_order_real_costs.sql
...
begin
  ...
  if (p_order->>'id') is not null and (p_order->>'id') != '' then
    ...
    -- WARNING: This deletes existing items. If real costs were updated via PayablesPage, 
    -- they MUST be passed back in p_items from the frontend to be preserved.
    -- OrderForm.tsx seems to handle this mapping.
  ...
  -- Insere os Itens do Pedido com colunas de custo real e status pago
